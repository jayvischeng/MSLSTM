...
if __name__=='__main__':
    ...
    case_list = [0]
    multi_scale_value = 7
    if filename == 'HB_Code_Red_I.txt':batch_size = 1200 - sequence_window
    elif filename == 'HB_Nimda.txt': batch_size = 7080 - sequence_window
    elif filename == 'HB_Slammer.txt': batch_size = 1920 - sequence_window
    #case_list = [0]
